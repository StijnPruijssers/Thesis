from models_drs import get_drs_cnn_1layer
import os
...
class myHypermodel(kt.HyperModel):
    def __init__(self, name=None, tunable=True, class_weights=[1, 1, 1, 1], x_size=1001):
        self.name = name
    ...
    def build(self, hp):
        ...
        model = get_drs_cnn_1layer(wavelengths=self.x_size,
                                   n_fibers=2,
    ...
    def run_trial(self, trial, *fit_args, **fit_kwargs):
        ...
        for i, (train_fold, val_fold) in enumerate(skf.split(data['train_ids'], data['labels_stratify'])):
            ...
            wandb.setup(wandb.Settings(
                program='Z:/Personal folder/Stijn Pruijssers (M3)_UT_2021/Software/Code/CRNN_git3/drs_exp2_1layer.py',
                program_relpath='drs_exp2_1layer.py', mode=params['wandb_mode']))
